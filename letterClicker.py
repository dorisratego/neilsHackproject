...
#setup asets folder
#gameFolder=os.path.dirname(\Users\HP\Desktop\neilpython\spacespell)
#imgFolder=os.path.join(gameFolder,'Assets')
# Load player and letter images
player_image = pygame.image.load(os.path.join("Assets","playerShip1_blue.png"))
...
letter_images = [pygame.image.load(os.path.join("Assets","enemyBlack1.png")), pygame.image.load(os.path.join("Assets","enemyBlack2.png")),
                 pygame.image.load(os.path.join("Assets","enemyBlack3.png")), pygame.image.load(os.path.join("Assets","enemyBlack4.png")),
                 pygame.image.load(os.path.join("Assets","enemyBlack5.png"))]
pygame.mixer.music.load(os.path.join('Assets','tgfcoder-FrozenJam-SeamlessLoop.ogg'))
...
#list of words
word_list = ["fed", "bad", "age", "dad", "bed","bag"]
